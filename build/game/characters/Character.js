...
class Character extends EventEmitter {
    ...
    set transport(_transport) {
        ...
        this._transport.on('disconnect', () => {
            log.debug({ characterId: this.id }, 'Disconnect event received; dis-associating from character');
            this._transport = null;
        });
        this._transport.on('message', (message) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (generatedCommands.length > 0) {
                    yield asyncForEach(generatedCommands, (command) => __awaiter(this, void 0, void 0, function* () {
                        yield command.execute(this);
                    }));
                }
                else {
                    const errorAction = DefaultCommandSet.commands[ErrorFactory.name]
                        .generate(rcvMessage.messageType, rcvMessage.parameters);
                    yield errorAction.execute(this);
                }
            }
            catch (e) {
    ...
    skillCheck(skillLevel, attribute) {
        var _a;
        const modifier = (_a = this.getAttributeModifier(attribute)) !== null && _a !== void 0 ? _a : 0;
    ...
    getSkill(skill) {
        ...
        const scholarLevel = (_a = this.skills.get('scholar')) !== null && _a !== void 0 ? _a : 0; // don't call recursively!
    ...
    _handleDeath() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.room) {
                ...
                const corpse = yield corpseFactory(this);
                if (corpse) {
                    ...
                    yield asyncForEach(currencies, (currencyDef) => __awaiter(this, void 0, void 0, function* () {
                        const currency = yield currencyFactory(currencyDef);
            ...
            yield asyncForEach(this.questsGiven, (quest) => __awaiter(this, void 0, void 0, function* () {
                yield quest.destroy();
            ...
            if (this.model.accountId) {
                ...
                yield CharacterModel.deleteOne({ _id: this.model._id });
                this.model = null;
            }
        });
    }
    ...
    load(loadSet = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!loadSet) {
                ...
                yield asyncForEach(Character.physicalLocations, (physicalLocation) => __awaiter(this, void 0, void 0, function* () {
                    if (this.model.physicalLocations[physicalLocation]) {
                        const modelDef = this.model.physicalLocations[physicalLocation].item;
                        if (modelDef) {
                            const item = yield loadInanimate(modelDef);
                            this.carryWeight += item.weight;
                ...
                if (this.model.conversationId) {
                    const conversationModel = yield ConversationModel.findById(this.model.conversationId);
                    if (!conversationModel) {
                        log.warn({ characterId: this.model._id.toString(), conversationId: this.model.conversationId.toString() }, 'Unable to find conversation for character');
                    }
                    else {
                        this.conversation = new Conversation(conversationModel, this);
                        yield this.conversation.load();
                    }
                }
                if (this.model.factions) {
                    yield asyncForEach(this.model.factions, (factionDef) => __awaiter(this, void 0, void 0, function* () {
                        yield this.factions.initializeFaction(factionDef.name, factionDef.value);
                    }));
                }
                if (this.model.questsCompleted) {
                    this.questsCompleted = [...this.model.questsCompleted];
                }
                const questModels = yield QuestModel.findByQuestGiver(this.model.characterRef);
                if (questModels) {
                    yield asyncForEach(questModels, (questModel) => __awaiter(this, void 0, void 0, function* () {
    ...
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            asyncForEach(this.questsGiven, (quest) => __awaiter(this, void 0, void 0, function* () {
                yield quest.save();
            }));
            yield this.model.save();
        });
