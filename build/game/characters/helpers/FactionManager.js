...
class FactionManager {
    ...
    adjustFaction(name, score) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._adjustFaction(name, modifier);
        });
    }
    /**
     ...
     */
    initializeFaction(name, score) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._adjustFaction(name, 0, score);
        });
    }
    /**
     ...
     *                                  seen the faction.
     */
    _adjustFaction(name, score, initialValue = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(name in this.factions)) {
                const factionModel = yield FactionModel.findOne({ name });
                if (!factionModel) {
     ...
     */
    processKill(deadCharacter) {
        return __awaiter(this, void 0, void 0, function* () {
            yield asyncForEach(deadCharacter.factions.factionScores(), (faction) => __awaiter(this, void 0, void 0, function* () {
